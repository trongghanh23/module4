...
public class FacilityController {
  ...
  @Autowired
    ...
    public String save(@ModelAttribute("showCreate") @Valid FacilityDto facilityDto, BindingResult bindingResult, RedirectAttributes redirectAttributes,Model model) {
