...
<head>
    <title>Title</title>
    <link href="webapp\WEB-INF\bootstrap\bootstrap-5.0.2-dist\css\bootstrap.css">
...
<div class="container">
    ...
    <form:form modelAttribute="HealthDeclaration" method="post" action="/save">
...
<script src="webapp\WEB-INF\bootstrap\bootstrap-5.0.2-dist\js\bootstrap.js"></script>
</html>
